  ...
  return (
    <Section title="Discover" image={{ src: imageWhiteboard }}>
      <div className="space-y-6 text-base text-neutral-600">
        <p>
          At Spectrum Pride, we work closely with families to understand their unique needs and goals, embedding ourselves in their daily routines to gain a deep understanding of their child’s strengths and challenges.
        </p>
        <p>
          Our dedicated team of ABA professionals observes your child in natural settings to identify opportunities for growth, while our behavior analysts develop individualized plans that are tailored to their specific needs.
        </p>
        <p>
          Once a thorough assessment is complete, we provide a detailed plan of action, including recommended therapies, measurable goals, and clear steps to help your child thrive. 
        </p>
      </div>
